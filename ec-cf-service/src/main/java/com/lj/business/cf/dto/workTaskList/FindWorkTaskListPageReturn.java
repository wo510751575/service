...
/**
 * The Class FindWorkTaskListPageReturn.
 */
public class FindWorkTaskListPageReturn implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -1779721167209418653L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindWorkTaskListPageReturn [code=").append(code)
