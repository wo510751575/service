...
/**
 * The Class FindWorkTaskPageReturn.
 */
public class FindWorkTaskPageReturn implements Serializable {
     
     /** Generate cron. */
	private static final long serialVersionUID = -2172063339824059506L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindWorkTaskPageReturn [code=").append(code)
