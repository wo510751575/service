...
/**
 * The Class UpdateWorkTask.
 */
public class UpdateWorkTask implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7008344081992691950L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		return "UpdateWorkTask [code=" + code + ", merchantNo=" + merchantNo
				...
				+ finish + ", reason=" + reason + ", taskType=" + taskType
				+ ", remark4=" + remark4 + ", remark3=" + remark3
				+ ", remark2=" + remark2 + ", remark=" + remark + ", taskUnit="
				+ taskUnit + "]";
	}
