...
/**
 * The Class AddWorkTaskListReturn.
 */
public class AddWorkTaskListReturn implements Serializable {
	
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7836276833529848834L;
    /**
     * CODE .
     */
    private String code;
