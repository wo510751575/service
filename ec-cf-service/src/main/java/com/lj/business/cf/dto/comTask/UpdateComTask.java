...
/**
 * The Class UpdateComTask.
 */
public class UpdateComTask implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2356721913902671748L;
	...
	/**
	 * Gets the 跟踪总表或维护总表code.
	 *
	 * @return the 跟踪总表或维护总表code
	 */
	...
	/**
	 * Sets the 跟踪总表或维护总表code.
	 *
	 * @param cfNo the new 跟踪总表或维护总表code
	 */
	...
	public String toString() {
		...
		builder.append("UpdateComTask [code=").append(code)
				...
				.append(noType).append(", finishDate=").append(finishDate)
				...
				.append(", remark=").append(remark).append(", memberNo=")
