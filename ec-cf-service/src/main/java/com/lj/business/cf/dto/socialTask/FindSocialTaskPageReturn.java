...
/**
 * The Class FindSocialTaskPageReturn.
 */
public class FindSocialTaskPageReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2558520695344440126L; 
	...
	public String toString() {
		...
		builder.append("FindSocialTaskPageReturn [code=").append(code)
				...
				.append(", workDate=").append(workDate).append(", finish=")
				.append(finish).append(", actionTask=").append(actionTask)
				.append(", reason=").append(reason).append(", idWx=")
				.append(idWx).append(", createId=").append(createId)
