...
/**
 * The Class FindComTaskChoosePageDto.
 */
public class FindComTaskChoosePageDto extends PageParamEntity{
     
     /** Generate cron. */
	private static final long serialVersionUID = -2017111319988160873L;
    ...
    public String getNextNameList() {
  	...
  	/**
	   * Sets the next name list.
	   *
	   * @param nextNameList the next name list
	   */
	...
	public String toString() {
		...
		builder.append("FindComTaskChoosePageDto [code=").append(code)
				...
				.append(nameList).append(", nextNameList=")
				.append(nextNameList).append(", status=").append(status)
				...
				.append(", memberNo=").append(memberNo).append(", remark2=")
