...
/**
 * The Class UpdateComTaskWorkflow.
 */
public class UpdateComTaskWorkflow implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6690101763219513411L;
	...
	public String toString() {
		...
		builder.append("UpdateComTaskWorkflow [code=").append(code)
