...
/**
 * The Class FindWorkTaskList.
 */
public class FindWorkTaskList implements Serializable { 
	
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -498460529429600547L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindWorkTaskList [code=").append(code)
