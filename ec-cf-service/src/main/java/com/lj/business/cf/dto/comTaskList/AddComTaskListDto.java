...
/**
 * The Class AddComTaskListDto.
 */
public class AddComTaskListDto implements Serializable{

	 /** Generate cron. */
	private static final long serialVersionUID = 5997734989674646211L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("AddComTaskListDto [code=").append(code)
