...
/**
 * The Class AddWorkTaskReturn.
 */
public class AddWorkTaskReturn implements Serializable {
     
     /** Generate cron. */
	private static final long serialVersionUID = 2383731909097169565L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("AddWorkTaskReturn [code=").append(code)
