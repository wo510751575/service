...
/**
 * The Class WorkTaskChooseReturnDto.
 */
public class WorkTaskChooseReturnDto implements Serializable{

	 /** Generate cron. */
	private static final long serialVersionUID = -413025352644238202L;
	   /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("WorkTaskChooseReturnDto [code=").append(code)
