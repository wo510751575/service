...
/**
 * The Class EditWorkTaskChooseDto.
 */
public class EditWorkTaskChooseDto extends PageParamEntity{

	 /** Generate cron. */
	private static final long serialVersionUID = -2625995544991770634L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("EditWorkTaskChooseDto [code=").append(code)
