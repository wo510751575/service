...
/**
 * The Class UpdateTaskSetShopDetail.
 */
public class UpdateTaskSetShopDetail implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -814410224058786566L;
	...
	public String toString() {
		...
		builder.append("UpdateTaskSetShopDetail [code=").append(code)
