...
/**
 * The Class UpdateWorkTaskGroup.
 */
public class UpdateWorkTaskGroup implements Serializable { 

     /** Generate cron. */
	private static final long serialVersionUID = 8066434389461560315L;
	...
	public String toString() {
		return "UpdateWorkTaskGroup [code=" + code + ", merchantNo="
