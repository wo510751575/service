...
/**
 * The Class FindClientKeepReturn.
 */
public class FindClientKeepReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -590796771285683857L;
	 /**
     * CODE .
     */
    private String code;
	...
	public void setKeepType(String keepType) {
		...
		if(!StringUtils.isEmpty(keepType)){
			this.keepTypeName = EnumUtils.getValue(KeepType.class, keepType);
		}
	}
	...
	public void setKeepTypeName(String keepTypeName) {
		this.keepTypeName = keepTypeName;
	}
	...
	public String toString() {
		...
		builder.append("FindClientKeepReturn [code=").append(code)
				...
				.append(", keepTypeName=").append(keepTypeName)
