...
/**
 * The Class FindTaskSetShopReturn.
 */
public class FindTaskSetShopReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5160474821455067654L;
	...
	public String toString() {
		...
		builder.append("FindTaskSetShopReturn [code=").append(code)
