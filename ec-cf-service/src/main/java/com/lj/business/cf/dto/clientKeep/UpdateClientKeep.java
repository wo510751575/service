...
/**
 * The Class UpdateClientKeep.
 */
public class UpdateClientKeep implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -7952698475152632159L;
	...
	public String toString() {
		...
		builder.append("UpdateClientKeep [code=").append(code)
