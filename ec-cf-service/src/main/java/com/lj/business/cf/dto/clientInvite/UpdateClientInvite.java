...
/**
 * The Class UpdateClientInvite.
 */
public class UpdateClientInvite implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -3814770059880047827L;
	...
	public String toString() {
		...
		builder.append("UpdateClientInvite [code=").append(code)
