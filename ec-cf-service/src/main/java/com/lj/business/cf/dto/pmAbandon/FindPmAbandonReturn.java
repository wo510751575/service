...
/**
 * The Class FindPmAbandonReturn.
 */
public class FindPmAbandonReturn implements Serializable { 

    /**
   /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4753335883046384737L;
	...
	public String toString() {
		...
		builder.append("FindPmAbandonReturn [code=").append(code)
				...
				.append(memberNoCheck).append(", resean=").append(resean)
