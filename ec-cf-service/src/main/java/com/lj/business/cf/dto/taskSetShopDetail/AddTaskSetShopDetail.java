...
/**
 * The Class AddTaskSetShopDetail.
 */
public class AddTaskSetShopDetail implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3228802766774136785L;
	...
	public String toString() {
		...
		builder.append("AddTaskSetShopDetail [code=").append(code)
