...
/**
 * The Class FindClientInviteReturn.
 */
public class FindClientInviteReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5069158271967121570L;
	...
	public String toString() {
		...
		builder.append("FindClientInviteReturn [code=").append(code)
