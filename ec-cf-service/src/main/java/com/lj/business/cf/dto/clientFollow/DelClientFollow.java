...
/**
 * The Class DelClientFollow.
 */
public class DelClientFollow implements Serializable {

	
	 /** Generate cron. */
	private static final long serialVersionUID = 5842245437687089152L; 
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("DelClientFollow [code=").append(code).append(", cfNo=")
				.append(cfNo).append(", merchantNo=").append(merchantNo)
