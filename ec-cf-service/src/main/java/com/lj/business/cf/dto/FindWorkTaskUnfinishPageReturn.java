...
/**
 * The Class FindWorkTaskUnfinishPageReturn.
 */
public class FindWorkTaskUnfinishPageReturn implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 8721114319005869383L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		return "WorkTaskUnfinish [code=" + code + ", merchantNo=" + merchantNo
				+ ", workDate=" + workDate + ", memberNoGm=" + memberNoGm
				+ ", memberNameGm=" + memberNameGm + ", taskListCode="
				+ taskListCode + ", taskName=" + taskName + ", requireNum="
				+ requireNum + ", finishNum=" + finishNum + ", unfinishNum="
				+ unfinishNum + ", defeatNum=" + defeatNum + ", workRatio="
				+ workRatio + ", finish=" + finish + ", reason=" + reason
