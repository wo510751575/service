...
/**
 * The Class FindWorkTaskUnfinishReturn.
 */
public class FindWorkTaskUnfinishReturn implements Serializable { 
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7925072970063862881L;
	   /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		return "FindWorkTaskUnfinishReturn [code=" + code + ", merchantNo="
