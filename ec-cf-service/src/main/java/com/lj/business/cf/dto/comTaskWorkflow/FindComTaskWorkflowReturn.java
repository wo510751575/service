...
/**
 * The Class FindComTaskWorkflowReturn.
 */
public class FindComTaskWorkflowReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1156008680840995484L;
	...
	public String toString() {
		...
		builder.append("FindComTaskWorkflowReturn [code=").append(code)
