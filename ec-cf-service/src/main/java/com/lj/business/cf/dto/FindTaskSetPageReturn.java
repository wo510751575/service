...
/**
 * The Class FindTaskSetPageReturn.
 */
public class FindTaskSetPageReturn implements Serializable {

	
	 /** Generate cron. */
	private static final long serialVersionUID = -7043564482150812476L; 
    /**
     * CODE .
     */
    private String code;
     ...
     * 商户编号列表，逗号分隔 .
     *
     * @param memberNoList the new 商户编号列表，逗号分隔 
     */
