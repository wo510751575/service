...
/**
 * The Class AddOtherTaskFinishInfo.
 */
public class AddOtherTaskFinishInfo implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -247115107084128255L;
	...
	public String toString() {
		...
		builder.append("AddOtherTaskFinishInfo [code=").append(code)
