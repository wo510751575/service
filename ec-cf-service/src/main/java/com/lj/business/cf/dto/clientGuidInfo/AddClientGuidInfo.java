...
/**
 * The Class AddClientGuidInfo.
 */
public class AddClientGuidInfo implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -3376131780272068500L;
	...
	public String toString() {
		...
		builder.append("AddClientGuidInfo [code=").append(code)
