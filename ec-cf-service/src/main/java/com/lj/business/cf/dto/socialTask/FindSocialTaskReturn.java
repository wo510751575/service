...
/**
 * The Class FindSocialTaskReturn.
 */
public class FindSocialTaskReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5566318421733473052L;
	...
	public String toString() {
		...
		builder.append("FindSocialTaskReturn [code=").append(code)
