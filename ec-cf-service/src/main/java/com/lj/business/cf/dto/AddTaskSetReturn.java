...
/**
 * The Class AddTaskSetReturn.
 */
public class AddTaskSetReturn implements Serializable {

	
	 /** Generate cron. */
	private static final long serialVersionUID = -6713721546576705597L; 
    /**
     * CODE .
     */
    private String code;
    ...
    public String toString() {
        ...
        builder.append("TaskSet [code=").append(code);
        builder.append(",merchantNo=").append(merchantNo); 
        builder.append(",memberNoSp=").append(memberNoSp); 
        builder.append(",memberNameSp=").append(memberNameSp); 
        builder.append(",numMonth=").append(numMonth); 
        builder.append(",memberNoList=").append(memberNoList); 
        builder.append(",memberNameList=").append(memberNameList); 
        builder.append(",numDay=").append(numDay); 
