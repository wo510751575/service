...
/**
 * The Class FindOtherTaskFinishInfoReturn.
 */
public class FindOtherTaskFinishInfoReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 6663345418185134334L;
	...
	public String toString() {
		...
		builder.append("FindOtherTaskFinishInfoReturn [code=").append(code)
