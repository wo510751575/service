...
/**
 * The Class UpdateClientGuidInfo.
 */
public class UpdateClientGuidInfo implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5486327104991837495L;
	...
	public String toString() {
		...
		builder.append("UpdateClientGuidInfo [code=").append(code)
