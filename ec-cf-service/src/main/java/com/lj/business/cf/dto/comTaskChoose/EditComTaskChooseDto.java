...
/**
 * The Class EditComTaskChooseDto.
 */
public class EditComTaskChooseDto implements Serializable{

	 /** Generate cron. */
	private static final long serialVersionUID = -5556681516632415732L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("EditComTaskChooseDto [code=").append(code)
