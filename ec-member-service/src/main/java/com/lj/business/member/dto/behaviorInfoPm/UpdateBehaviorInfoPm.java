...
/**
 * The Class UpdateBehaviorInfoPm.
 */
public class UpdateBehaviorInfoPm implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6638809698827055091L;
	...
	public String toString() {
		...
		builder.append("UpdateBehaviorInfoPm [code=").append(code)
				.append(", behaviorDesc=").append(behaviorDesc)
				.append(", behaviorDate=").append(behaviorDate)
				.append(", behaviorCode=").append(behaviorCode)
