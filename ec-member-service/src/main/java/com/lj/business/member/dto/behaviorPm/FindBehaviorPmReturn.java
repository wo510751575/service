...
/**
 * The Class FindBehaviorPmReturn.
 */
public class FindBehaviorPmReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 892847684197558293L;
	...
	public String toString() {
		...
		builder.append("FindBehaviorPmReturn [code=").append(code)
