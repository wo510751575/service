...
/**
 * The Class FindCustKeepReturn.
 */
public class FindCustKeepReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5928087756510630486L;
	...
	public String toString() {
		...
		builder.append("FindCustKeepReturn [code=").append(code)
