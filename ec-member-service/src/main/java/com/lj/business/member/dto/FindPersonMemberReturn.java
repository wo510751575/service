...
public class FindPersonMemberReturn implements Serializable { 
	...
	public String toString() {
		...
		builder.append("FindPersonMemberReturn [code=").append(code)
				...
				.append(", remark=").append(remark).append(", scanAddress=")
				.append(scanAddress).append(", latitude=").append(latitude)
