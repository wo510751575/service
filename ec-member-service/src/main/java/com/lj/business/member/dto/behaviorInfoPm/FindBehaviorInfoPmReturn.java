...
/**
 * The Class FindBehaviorInfoPmReturn.
 */
public class FindBehaviorInfoPmReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4528237950783932134L;
	...
	public String toString() {
		...
		builder.append("FindBehaviorInfoPmReturn [code=").append(code)
