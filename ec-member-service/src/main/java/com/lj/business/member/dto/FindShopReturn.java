 ...
 */
public class FindShopReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5909634266532906080L;
	...
	public String toString() {
		...
		builder.append("FindShopReturn [code=").append(code)
				...
				.append(", createId=").append(createId).append(", openDate=")
				.append(openDate).append(", createDate=").append(createDate)
