...
/**
 * The Class UpdateManagerMemberReturn.
 */
public class UpdateManagerMemberReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -7135408818207573480L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("UpdateManagerMemberReturn [code=").append(code)
