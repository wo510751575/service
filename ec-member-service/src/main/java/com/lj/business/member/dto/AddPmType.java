 ...
 * The Class AddPmType.
 */
public class AddPmType implements Serializable { 

	 
	 /** Generate cron. */
	private static final long serialVersionUID = 5917206180001402931L;
 ...
 其他：OTHER .
	...
	public String toString() {
		...
		builder.append("AddPmType [merchantNo=").append(merchantNo)
				...
				.append(remark4).append(", freValue=").append(freValue)
				.append("]");
