...
/**
 * The Class FindPmTypeReturn.
 */
public class FindPmTypeReturn implements Serializable { 

	 
	 /** Generate cron. */
	private static final long serialVersionUID = -7345703267843078748L;
	 /**
     * CODE .
     */
    private String code;
 ...
 其他：OTHER .
	...
	public String toString() {
		...
		builder.append("FindPmTypeReturn [code=").append(code)
				...
				.append(", freValue=").append(freValue).append("]");
