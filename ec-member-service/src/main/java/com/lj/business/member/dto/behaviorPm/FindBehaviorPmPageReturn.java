...
/**
 * The Class FindBehaviorPmPageReturn.
 */
public class FindBehaviorPmPageReturn implements Serializable { 
	

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1489233654360181735L;
	...
	public String toString() {
		...
		builder.append("FindBehaviorPmPageReturn [code=").append(code)
				...
				.append(behaviorDate).append(", createDate=")
