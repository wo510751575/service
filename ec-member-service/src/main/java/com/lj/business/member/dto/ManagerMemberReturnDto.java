...
/**
 * The Class ManagerMemberReturnDto.
 */
public class ManagerMemberReturnDto implements Serializable{
	
     /** Generate cron. */
	private static final long serialVersionUID = -2484103404463688745L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("ManagerMemberReturnDto [code=").append(code)
