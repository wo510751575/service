...
public class StringUtils {
	...
	public static void main(String args []){
		System.out.println( replay("wx,no,ss,wx,no"));
	}
	 ...
	 * @return
	 */
	public static String replay(String str) {
		if(StringUtils.isEmpty(str)) {
			return "";
		}
		Set<String> noReplayWx = new HashSet<String>();
		
		String[] whoNoWxs=str.split(",");
		for (String string : whoNoWxs) {
			noReplayWx.add(string);
		}
		StringBuffer sb = new StringBuffer();
		for (String string : noReplayWx) {
