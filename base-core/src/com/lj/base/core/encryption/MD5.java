...
public class MD5 {   
	...
	public static String encryptToBase64(String data) {
		...
		{   
			...
			//s = new String(UrlBase64.encode(tmp));
		}catch( Exception e ) {   
			e.printStackTrace();   
		}   
		return s;  
	 ...
	 *
	 */
	public static String encryptToUrlBase64(String data) {
		String s = null;   
		byte[] source = null;
		try {
			source = data.getBytes(EncrptyConstants.ENCODE_UTF8);
	...
	public static void main(String args []){
		...
		//	System.out.println(encryptByMD5Twice("1647381382729274042","6473813827"));
			...
			System.out.println(encryptToUrlBase64("wxid_vhpyoqvaxca722"));
			System.out.println(encryptToUrlBase64("1111111111"));
			System.out.println(encryptToUrlBase64("2222"));
			System.out.println(encryptToUrlBase64("333"));
			System.out.println(encryptToUrlBase64("333"));
			System.out.println(encryptToUrlBase64("333"));
			System.out.println(encryptToUrlBase64("333").replace(".", ""));
