...
public class Base64 {
    ...
    public static void main(String args []){
		String str = new String(Base64.encodeBase64("wxid_vhpyoqvaxca722".getBytes()));
		System.out.println( str);
		System.out.println(new String( Base64.decode2(str)) );
		
		 str = new String(Base64.encodeBase64("wxid_vhpyoqvaxca722".getBytes()));
		System.out.println( str);
    }
